...
export default function Result({ params, searchParams }) {
  ...
  return (
    <>
      <Title>{isSuccess ? (<>Flawless<br />Victory</>) : (<>That<br />Sucked</>)}</Title>
      <p className="text-center text-2xl font-medium">{isSuccess ? (<>{percentage*100}%<br /> of your fellow humans succeeded</>) : 'What are you gonna do about it?'}</p>
